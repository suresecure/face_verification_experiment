...
# caffe_root = '/home/robert/myCoding/caffe-rc/'
caffe_root = '/home/robert/myCoding/caffe/'
# caffe_root = '/home/robert/myCoding/caffe-rc/build/install/'
...
def extract_feature(network_proto_path,
    ...
    if not image_as_grey:
        ...
        net = caffe.Classifier(network_proto_path, network_model_path,
                           mean = data_mean,
                           input_scale = 1, channel_swap = channel_swap)
    else:
        net = caffe.Classifier(network_proto_path, network_model_path,
                           mean = data_mean,
                           input_scale = 1)

    # print 'channel_swap is:'
    # print channel_swap
    # print 'image_as_grey is:'
    # print image_as_grey
    # print 'Extract layer is:'
    # print layer_name
